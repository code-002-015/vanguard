...
// side nav/quicklinks  -----------------------------
var arrow = '<i class="icon-chevron-down1 down"></i>';
$(".quicklinks li").find("ul").parent("li").prepend(arrow);
$(".quicklinks i").click(function(){
	$(this).siblings("ul").stop(true).slideToggle();
	$(this).toggleClass("down up");
	$(this).parent().siblings().find("ul").slideUp();
	$(this).parent().siblings().find("i").removeClass("up").addClass("down");
});
$(".quicklinks .current").children("ul").slideDown();
$(".quicklinks .current").find("i").removeClass("down").addClass("up");
...
function closeOffsideNav() {
  document.getElementById("mySidenav").style.left = "-320px";
  document.getElementById("curtain").style.display = "none";
}


// subpage breadcrumbs and title head  -----------------------------
...
// main banner and sub banner height  -----------------------------
// var screen =  window.innerHeight;
// var header = $("header").height();
// $(".slick-carousel, .slick-carousel .swiper-slide").css("height",screen/1.4); //main banner height
// $(".sub-banner, .sub-banner .swiper-slide, .sub-banner .swiper-container").css("height",screen/3.8); //sub banner height
// $("#page-title").css("top",screen/15); //sub banner align caption/title
function myFunction(x) {
	if (x.matches) {
		$("#mySidenav").addClass("side-nav"); //side navigation
		// $(".slick-carousel, .slick-carousel .swiper-slide").css("height",screen/1.6); //main banner height on tablet/mobile
		// $(".sub-banner, .sub-banner .swiper-slide, .sub-banner .swiper-container").css("height",screen/4); //sub banner height on tablet /mobile
  	} else {
		$("#mySidenav").removeClass("side-nav"); //side navigation
  	}
}
