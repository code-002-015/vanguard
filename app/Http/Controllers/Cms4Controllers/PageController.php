...
class PageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cms4.pages.index', compact('pages', 'filter', 'advanceSearchData', 'uniquePagesByAlbum', 'uniquePagesByUser', 'searchType'));
    }
    ...
    public function advance_index(Request $request)
    {
        ...
        return view('cms4.pages.index', compact('pages', 'filter', 'advanceSearchData', 'uniquePagesByParent', 'uniquePagesByAlbum', 'uniquePagesByUser', 'searchType'));
    }
    ...
    public function create()
    {
        ...
        return view('cms4.pages.create', compact('albums', 'pages'));
    }
    ...
    public function edit(Page $page)
    {
        ...
        if ($page->is_contact_us_page()) {
            ...
            return view('cms4.pages.customize', compact('page', 'parentPages', 'albums', 'pageAlbum'));
        } else {
            return view('cms4.pages.edit', compact('page', 'parentPages', 'albums', 'pageAlbum'));
        }
    }
