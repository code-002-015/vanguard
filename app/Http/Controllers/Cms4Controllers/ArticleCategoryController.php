...
class ArticleCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cms4.news.category_index',compact('categories','filter', 'searchType'));
    }
    ...
    {
        return view('cms4.news.category_create');
    }
    ...
    {
        return view('cms4.news.category_edit',compact('newsCategory'));
    }
