...
class ArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cms4.news.index', compact('news', 'filter', 'advanceSearchData', 'uniqueNewsByCategory', 'uniqueNewsByUser', 'searchType'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('cms4.news.create', compact('categories'));
    }
    ...
    public function edit(Request $request, Article $news)
    {
        ...
        return view('cms4.news.edit', compact('news', 'categories'));
    }
