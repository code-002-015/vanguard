            ...
            <div class="col-md-6">
                <form action="{{ route('career-categories.update', $careerCategory->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="category_title" value="{{ $careerCategory->name }}" @htmlValidationMessage({{__('standard.empty_all_field')}})>
