                        ...
                        <table class="table mg-b-0 table-light table-hover" style="width:100%;">
                            ...
                            @forelse($careers as $career)
                                <tr id="row{{ $career->id }}" class="row_cb">
                                    ...
                                    <td @if($career->category->trashed()) style="text-decoration:line-through;" @endif  style="overflow: hidden;text-overflow: ellipsis;" title="{{$career->category->name}}">{{ $career->category->name }}</td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        @else
                                            <nav class="nav table-options justify-content-end">
                                                <a class="nav-link" target="_blank" href="{{ route('careers.front.show',[$career->category->slug,$career->id]) }}" title="View Page"><i data-feather="eye"></i></a>
                            ...
                            @empty
                                <tr>
                                    <th colspan="8" style="text-align: center;"> <p class="text-danger">No careers found.</p></th>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
